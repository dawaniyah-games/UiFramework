...
namespace UiFramework.Core
{
    public class UiState : IDisposable
    {
        ...
        /// <summary>
        /// Waits for any pending Addressables scene loads started by <see cref="Init"/> to complete.
        /// Call this after <see cref="Init(object)"/> if you need to ensure scenes are loaded before continuing.
        /// </summary>
